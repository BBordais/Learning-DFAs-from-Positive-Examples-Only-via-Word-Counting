...
# ~ nameFile : the path of the Trace file
# ~ saveFile : the path where to store the computed DFA
# ~ n : number of states
# ~ h : the maximum length of the considered words
# ~ t : the timeout (in second)
